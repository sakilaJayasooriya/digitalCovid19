...
<div class="container-fluid bg-green mb-5">	
	<div class="row"> 
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
			<nav id="navId" class="navbar bg-green navbar-expand-md fixed-top shadow-sm">
			  ...
			  <div class="collapse navbar-collapse justify-content-between pr-4" id="collapsibleNavbar">
			    ...
			    <ul type="hidden" id="UNameTop" class="navbar-nav text-left pr-5">
			    	<li class="nav-item">
